...
// Copyright (c) 2011-2013 The HSC developers
...
namespace Checkpoints
{
    ...
    // HSC: synchronized checkpoint (centrally broadcasted)
    ...
    // HSC: get last synchronized checkpoint
    ...
    // HSC: only descendant of current sync-checkpoint is allowed
    ...
    // HSC: reset synchronized checkpoint to last hardened checkpoint
...
// HSC: verify signature of sync-checkpoint message
...
// HSC: process synchronized checkpoint
